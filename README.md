...
- I'm completing this project to enhance my skills within the DevSecOps field and become a better applicant for future jobs.
...
- **AWS CodeArtifact**: CodeArtifact is storing my artifacts and dependencies, which is great for high availability and speeding up my project's build process.
- **AWS CodeBuild**: CodeBuild has taken over my build process. It compile's the source code, run tests, and produce ready-to-deploy software packages automatically.
...
Lachlan Ballard
OR my linkedin
https://www.linkedin.com/in/lachlan-ballard/
